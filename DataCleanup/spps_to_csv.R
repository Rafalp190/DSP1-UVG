...
write.csv(f09csv, file = "./Data/09F.csv", row.names = F)

#Conversion of the .sav file of injured of 2009 to
l09 <- read.spss("./Datos_brutos/09L.sav")
l09csv <- data.frame(l09)
write.csv(l09csv, file = "./Data/09L.csv", row.names = F)
...
write.csv(fl10csv, file = "./Data/10FL.csv", row.names = F)
...
write.csv(fl11csv, file = "./Data/11FL.csv", row.names = F)
...
write.csv(fl12csv, file = "./Data/12FL.csv", row.names = F)
...
write.csv(fl11csv, file = "./Data/13FL.csv", row.names = F)
...
write.csv(vi10csv, file = "./Data/10VI.csv", row.names = F)
...
write.csv(vi12csv, file = "./Data/12VI.csv", row.names = F)
...
write.csv(vi13csv, file = "./Data/13VI.csv", row.names = F)
...
write.csv(vi14csv, file = "./Data/14VI.csv", row.names = F)
